    ...
    <div className="mx-auto mt-4 max-w-screen-xl px-4">
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="bg-[#37BFC4] h-60 w-fit border rounded-lg justify-self-center">
          ...
          <div className="flex flex-row justify-between">
            <div>
              <p className="text-white text-lg font-poppins p-2">Cancer Care</p>
            </div>
            <div className="p-2">
              <button className="p-2 border rounded-full transition-colors duration-200 hover:bg-white">
                <img src={arrow} className="h-4" alt="Arrow" />
        ...
        <div className="bg-[#37BFC4] h-60 w-fit border rounded-lg justify-self-center">
          ...
          <div className="flex flex-row justify-between">
            <div>
              <p className="text-white text-lg font-poppins p-2">Naturopathy</p>
            </div>
            <div className="p-2">
              <button className="p-2 border rounded-full transition-colors duration-200 hover:bg-white">
                <img src={arrow} className="h-4" alt="Arrow" />
        ...
        <div className="bg-[#37BFC4] h-60 w-fit border rounded-lg justify-self-center">
          ...
          <div className="flex flex-row justify-between">
            <div>
              <p className="text-white text-lg font-poppins p-2">Dermatology</p>
            </div>
            <div className="p-2">
              <button className="p-2 border rounded-full transition-colors duration-200 hover:bg-white">
                <img src={arrow} className="h-4" alt="Arrow" />
        ...
        <div className="bg-[#37BFC4] h-60 w-fit border rounded-lg justify-self-center">
          ...
          <div className="flex flex-row justify-between">
            <div>
              <p className="text-white text-lg font-poppins p-2">Gynaecology</p>
            </div>
            <div className="p-2">
              <button className="p-2 border rounded-full transition-colors duration-200 hover:bg-white">
                <img src={arrow} className="h-4" alt="Arrow" />
